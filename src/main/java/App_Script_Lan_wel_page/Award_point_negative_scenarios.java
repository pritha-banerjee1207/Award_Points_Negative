...
public class Award_point_negative_scenarios extends Generic_function{
	...
	public static void Award_point_negative_tc_002() throws IOException {
		try {
			...
			ele=driver.findElement(By.xpath(OR_reader("Object_Locator","redeem_points_amount")));
    		ele.sendKeys(Keys.BACK_SPACE);
			ele.sendKeys(td_reader("redeem_points_amount",3));
  			click("redeem_points_email");
	...
	/*TC 003 -  Validate that user is not able to click on the 'Redeem' button on leaving the field ''Enter Amount'' blank on "Redeem Award Points" page */
